...
class ResNet(nn.Module):
    ...
    def __init__(
        ...
        #     nn.ReLU(inplace=True),
        # )
        self.density_layer = nn.Sequential(nn.Conv2d(2048, 1, 1), nn.ReLU())
        ...
        # so that the residual branch starts with
...
def resnet101(pretrained: bool = True, progress: bool = True, **kwargs: Any) -> ResNet:
    ...
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
        progress (bool): If True, displays a 
        progress bar of the download to stderr
    """
